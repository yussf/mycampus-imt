        ...
        for (let k in data) {
            if (data.hasOwnProperty(k)) {
                ...
                if (data[k].type == 'VEVENT') {
                    text = text + `- ${ev.summary} | ${ev.location} | ${ev.start.getDate()} of ${months[ev.start.getMonth()]} | ${ev.start.toLocaleTimeString(['fr-FR'], {hour: '2-digit', minute: '2-digit', hour12: true})} \n \n`
